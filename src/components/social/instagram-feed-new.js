    ...
    const posts = [
      {
        id: "1",
        media_url:
          "https://via.placeholder.com/300x300/004ca3/white?text=Instagram+Post+1",
      ...
      },
      {
        id: "2",
        media_url:
          "https://via.placeholder.com/300x300/004ca3/white?text=Instagram+Post+2",
      ...
      },
      {
        id: "3",
        media_url:
          "https://via.placeholder.com/300x300/004ca3/white?text=Instagram+Post+3",
      ...
      },
      {
        id: "4",
        media_url:
          "https://via.placeholder.com/300x300/004ca3/white?text=Instagram+Post+4",
      ...
      },
      {
        id: "5",
        media_url:
          "https://via.placeholder.com/300x300/004ca3/white?text=Instagram+Post+5",
      ...
      },
      {
        id: "6",
        media_url:
          "https://via.placeholder.com/300x300/004ca3/white?text=Instagram+Post+6",
...
4. Refresh the page`)
  ...
  if (loading) {
    return (
      <Box marginY={5}>
        <Heading as="h3" center marginY={3}>
          Instagram Feed
        </Heading>
  ...
  if (error && posts.length === 0) {
    return (
      <Box marginY={5}>
        ...
        <Text center style={{ color: "#666", marginBottom: "1rem" }}>
          {error}
        </Text>
        <Box center>
          <button
